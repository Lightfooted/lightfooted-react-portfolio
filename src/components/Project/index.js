    ...
    <main>
      <div className='relative flex justify-center p-20 mx-auto lg:pt-18'>
        <div className="grid grid-cols-1 gap-4 p-10 text-center text-white bg-black rounded-lg shadow-2xl lg:grid-cols-4 bg-opacity-80">
          ...
          <div>
            <a href='https://protected-hamlet-00069.herokuapp.com/' rel='noopener noreferrer' target='_blank'>Second Group Project: Pokedex-Project<img src={SecondGrpProject} alt='pokedex-project'/></a>
          ...
          <div>
            <a href='https://high-tech-match.herokuapp.com/' rel='noopener noreferrer' target='_blank'>Final Group Project: High Tech Match Love<img src={LastGrpProject} alt='final-project'/></a>
          ...
          <div>
            <a href='https://lightfooted.github.io/password-generator/' rel='noopener noreferrer' target='_blank'>Module Assignment: Password Generator<img src={Password} alt='pass'/></a>
          ...
          <div>
            <a href='https://www.youtube.com/watch?v=HzrT7pC8dTw' rel='noopener noreferrer' target='_blank'>Module Assignment: README Generator<img src={README} alt='gen'/></a>
          ...
          <div>
            <a href='https://www.youtube.com/watch?v=2tp7mEg7tNU' rel='noopener noreferrer' target='_blank'>Module Assignment: Social Network API<img src={NetAPI} alt='n-api'/></a>
          ...
          <div>
            <a href='https://agile-scrubland-63874.herokuapp.com/' rel='noopener noreferrer' target='_blank'>Module Assignment: Offline Budget Tracker<img src={BudgetAssignment} alt='budget-tracker'/></a>
